...
class CbtController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $data = $request->validate([
      ...
      'security_policy.max_warnings' => 'nullable|integer|min:1|max:2',
      'security_policy.auto_submit_on_violation' => 'nullable|boolean',
      'security_policy.auto_submit_on_fullscreen_exit' => 'nullable|boolean',
      'security_policy.auto_submit_on_camera_blocked' => 'nullable|boolean',
      'security_policy.auto_submit_on_no_face' => 'nullable|boolean',
      'security_policy.auto_submit_on_multiple_faces' => 'nullable|boolean',
      'security_policy.auto_submit_on_sound_detected' => 'nullable|boolean',
      'security_policy.sound_detection_enabled' => 'nullable|boolean',
      'security_policy.sound_threshold' => 'nullable|numeric|min:0.01|max:1',
      'security_policy.sound_duration_seconds' => 'nullable|integer|min:1|max:30',
