...
<body>
@php
    $paymentAt = $payment?->paid_at ?: $payment?->created_at;
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="receipt-meta" style="width:180px;">
                ...
                <div><strong>Status:</strong> {{ strtoupper((string) ($payment?->status ?? '-')) }}</div>
                <div><strong>Generated:</strong> {{ $generatedLabel }}</div>
            </td>
        </tr>
    </table>
    <div class="title-band">FEE RECEIPT</div>
</div>
        ...
        <td>
            <table class="summary-table">
                ...
                <tr>
                    ...
                    <td class="money">{{ number_format((float) ($payment?->amount_paid ?? 0), 2) }}</td>
                </tr>
                <tr>
