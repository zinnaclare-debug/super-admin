            ...
            <div className="cbx-security">
              ...
              <div className="cbx-security-grid">
                {[
                  ...
                  ["auto_submit_on_camera_blocked", "Submit if camera blocked"],
                  ["auto_submit_on_no_face", "Submit if no face"],
                  ["auto_submit_on_multiple_faces", "Submit if multiple faces"],
                  ["auto_submit_on_sound_detected", "Submit if sound is detected"],
